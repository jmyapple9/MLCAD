...
void logInput() {
    int logNum = 10;
    cout << endl << "Total node number are: " << node_num << endl << endl;

    // Nets
    cout << "The first " << logNum << " of nets are: " << endl << endl;
    cout << "###############################################################" << endl << endl;
    ...
    // Nodes
    cout << "The first " << logNum << " of nodes are : " << endl << endl;
    cout << "###############################################################" << endl << endl;
    for (int i=0; i<logNum; ++i) {
        ...
        cout << "Node fixed: " << nodes[i].fixed << endl << endl;
    }
